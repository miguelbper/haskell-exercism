...
libdir     = "C:\\Users\\Miguel\\Exercism\\haskell\\run-length-encoding\\.stack-work\\install\\e0f1c74b\\lib\\x86_64-windows-ghc-8.8.4\\run-length-encoding-1.1.0.5-4poYsoYV2tIFmRqxV24ypr"
